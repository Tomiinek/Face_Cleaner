...
void InitDefaultsSaverDef() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsSaverDefImpl);
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::SaverDef* Arena::CreateMessage< ::tensorflow::SaverDef >(Arena* arena) {
