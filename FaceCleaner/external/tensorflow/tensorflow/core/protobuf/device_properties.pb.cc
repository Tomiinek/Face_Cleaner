...
void InitDefaultsDeviceProperties_EnvironmentEntry_DoNotUse() {
  ...
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsDeviceProperties_EnvironmentEntry_DoNotUseImpl);
}
...
void InitDefaultsDevicePropertiesImpl() {
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_tensorflow_2fcore_2fprotobuf_2fdevice_5fproperties_2eproto::InitDefaultsDeviceProperties_EnvironmentEntry_DoNotUse();
  {
...
void InitDefaultsDeviceProperties() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsDevicePropertiesImpl);
}
...
void InitDefaultsNamedDevice() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsNamedDeviceImpl);
}
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      ...
      "sorflow.DevicePropertiesB\033B\026DeviceProper"
      "tiesProtos\370\001\001b\006proto3"
  };
...
void DeviceProperties::SerializeWithCachedSizes(
  ...
  if (!this->environment().empty()) {
    ...
    if (output->IsSerializationDeterministic() &&
      ...
      ::google::protobuf::scoped_ptr<DeviceProperties_EnvironmentEntry_DoNotUse> entry;
...
NamedDevice::NamedDevice()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_tensorflow_2fcore_2fprotobuf_2fdevice_5fproperties_2eproto::InitDefaultsNamedDevice();
  }
  SharedCtor();
  ...
  if (this->has_properties()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        2, *properties_, deterministic, target);
  }
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::DeviceProperties_EnvironmentEntry_DoNotUse* Arena::CreateMessage< ::tensorflow::DeviceProperties_EnvironmentEntry_DoNotUse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::tensorflow::DeviceProperties_EnvironmentEntry_DoNotUse >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::DeviceProperties* Arena::CreateMessage< ::tensorflow::DeviceProperties >(Arena* arena) {
  return Arena::CreateMessageInternal< ::tensorflow::DeviceProperties >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::NamedDevice* Arena::CreateMessage< ::tensorflow::NamedDevice >(Arena* arena) {
