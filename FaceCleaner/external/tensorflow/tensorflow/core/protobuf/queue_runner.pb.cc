...
void InitDefaultsQueueRunnerDefImpl() {
...
void InitDefaultsQueueRunnerDef() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsQueueRunnerDefImpl);
}
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "tensorflow/core/protobuf/queue_runner.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
QueueRunnerDef::QueueRunnerDef()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_tensorflow_2fcore_2fprotobuf_2fqueue_5frunner_2eproto::InitDefaultsQueueRunnerDef();
  }
  SharedCtor();
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::QueueRunnerDef* Arena::CreateMessage< ::tensorflow::QueueRunnerDef >(Arena* arena) {
