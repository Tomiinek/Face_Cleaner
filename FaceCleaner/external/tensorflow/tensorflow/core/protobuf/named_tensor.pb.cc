...
void InitDefaultsNamedTensorProto() {
  ...
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsNamedTensorProtoImpl);
}
  ...
  if (this->has_tensor()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        2, *tensor_, deterministic, target);
  }
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::NamedTensorProto* Arena::CreateMessage< ::tensorflow::NamedTensorProto >(Arena* arena) {
