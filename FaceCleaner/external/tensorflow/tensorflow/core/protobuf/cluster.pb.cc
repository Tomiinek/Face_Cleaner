...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::JobDef_TasksEntry_DoNotUse* Arena::CreateMessage< ::tensorflow::JobDef_TasksEntry_DoNotUse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::tensorflow::JobDef_TasksEntry_DoNotUse >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::JobDef* Arena::CreateMessage< ::tensorflow::JobDef >(Arena* arena) {
  return Arena::CreateMessageInternal< ::tensorflow::JobDef >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::ClusterDef* Arena::CreateMessage< ::tensorflow::ClusterDef >(Arena* arena) {
