...
void InitDefaultsIteratorStateMetadata() {
  ...
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsIteratorStateMetadataImpl);
}
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::tensorflow::IteratorStateMetadata, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::tensorflow::IteratorStateMetadata, version_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::tensorflow::IteratorStateMetadata, keys_),
};
...
IteratorStateMetadata::IteratorStateMetadata()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_tensorflow_2fcore_2fframework_2fiterator_2eproto::InitDefaultsIteratorStateMetadata();
  }
  SharedCtor();
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::IteratorStateMetadata* Arena::CreateMessage< ::tensorflow::IteratorStateMetadata >(Arena* arena) {
