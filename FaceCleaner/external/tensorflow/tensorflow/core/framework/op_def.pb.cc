...
void InitDefaultsOpDefImpl() {
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_tensorflow_2fcore_2fframework_2fop_5fdef_2eproto::InitDefaultsOpDef_ArgDef();
  protobuf_tensorflow_2fcore_2fframework_2fop_5fdef_2eproto::InitDefaultsOpDef_AttrDef();
  protobuf_tensorflow_2fcore_2fframework_2fop_5fdef_2eproto::InitDefaultsOpDeprecation();
  {
...
::google::protobuf::uint8* OpDef_AttrDef::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->has_allowed_values()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        7, *allowed_values_, deterministic, target);
  }
...
::google::protobuf::uint8* OpDef::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->has_deprecation()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        8, *deprecation_, deterministic, target);
  }
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::OpDef_ArgDef* Arena::CreateMessage< ::tensorflow::OpDef_ArgDef >(Arena* arena) {
  return Arena::CreateMessageInternal< ::tensorflow::OpDef_ArgDef >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::OpDef_AttrDef* Arena::CreateMessage< ::tensorflow::OpDef_AttrDef >(Arena* arena) {
  return Arena::CreateMessageInternal< ::tensorflow::OpDef_AttrDef >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::OpDef* Arena::CreateMessage< ::tensorflow::OpDef >(Arena* arena) {
  return Arena::CreateMessageInternal< ::tensorflow::OpDef >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::OpDeprecation* Arena::CreateMessage< ::tensorflow::OpDeprecation >(Arena* arena) {
  return Arena::CreateMessageInternal< ::tensorflow::OpDeprecation >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::OpList* Arena::CreateMessage< ::tensorflow::OpList >(Arena* arena) {
