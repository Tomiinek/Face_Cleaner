...
void InitDefaultsNodeDefImpl() {
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_tensorflow_2fcore_2fframework_2fnode_5fdef_2eproto::InitDefaultsNodeDef_AttrEntry_DoNotUse();
  {
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::NodeDef_AttrEntry_DoNotUse* Arena::CreateMessage< ::tensorflow::NodeDef_AttrEntry_DoNotUse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::tensorflow::NodeDef_AttrEntry_DoNotUse >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::NodeDef* Arena::CreateMessage< ::tensorflow::NodeDef >(Arena* arena) {
