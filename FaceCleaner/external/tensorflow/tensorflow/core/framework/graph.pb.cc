...
::google::protobuf::uint8* GraphDef::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->has_library()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        2, *library_, deterministic, target);
  }
  ...
  if (this->has_versions()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        4, *versions_, deterministic, target);
  }
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::GraphDef* Arena::CreateMessage< ::tensorflow::GraphDef >(Arena* arena) {
