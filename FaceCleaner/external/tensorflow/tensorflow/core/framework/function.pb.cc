...
void InitDefaultsFunctionDefLibraryImpl() {
  ...
  protobuf_tensorflow_2fcore_2fframework_2ffunction_2eproto::InitDefaultsFunctionDef();
  protobuf_tensorflow_2fcore_2fframework_2ffunction_2eproto::InitDefaultsGradientDef();
  {
...
void InitDefaultsFunctionDefImpl() {
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_tensorflow_2fcore_2fframework_2fop_5fdef_2eproto::InitDefaultsOpDef();
  protobuf_tensorflow_2fcore_2fframework_2ffunction_2eproto::InitDefaultsFunctionDef_AttrEntry_DoNotUse();
  protobuf_tensorflow_2fcore_2fframework_2fnode_5fdef_2eproto::InitDefaultsNodeDef();
  protobuf_tensorflow_2fcore_2fframework_2ffunction_2eproto::InitDefaultsFunctionDef_RetEntry_DoNotUse();
  {
...
FunctionDefLibrary::FunctionDefLibrary()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_tensorflow_2fcore_2fframework_2ffunction_2eproto::InitDefaultsFunctionDefLibrary();
  }
  SharedCtor();
...
::google::protobuf::uint8* FunctionDef::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->has_signature()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        1, *signature_, deterministic, target);
  }
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::FunctionDefLibrary* Arena::CreateMessage< ::tensorflow::FunctionDefLibrary >(Arena* arena) {
  return Arena::CreateMessageInternal< ::tensorflow::FunctionDefLibrary >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::FunctionDef_AttrEntry_DoNotUse* Arena::CreateMessage< ::tensorflow::FunctionDef_AttrEntry_DoNotUse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::tensorflow::FunctionDef_AttrEntry_DoNotUse >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::FunctionDef_RetEntry_DoNotUse* Arena::CreateMessage< ::tensorflow::FunctionDef_RetEntry_DoNotUse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::tensorflow::FunctionDef_RetEntry_DoNotUse >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::FunctionDef* Arena::CreateMessage< ::tensorflow::FunctionDef >(Arena* arena) {
  return Arena::CreateMessageInternal< ::tensorflow::FunctionDef >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::GradientDef* Arena::CreateMessage< ::tensorflow::GradientDef >(Arena* arena) {
