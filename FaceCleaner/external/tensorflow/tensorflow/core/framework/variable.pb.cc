...
void InitDefaultsVariableDefImpl() {
  ...
  protobuf_tensorflow_2fcore_2fframework_2fvariable_2eproto::InitDefaultsSaveSliceInfoDef();
  {
...
void InitDefaultsVariableDef() {
  ...
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsVariableDefImpl);
}
...
void InitDefaultsSaveSliceInfoDef() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsSaveSliceInfoDefImpl);
}
...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 11, -1, sizeof(::tensorflow::SaveSliceInfoDef)},
};
...
VariableDef::VariableDef()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_tensorflow_2fcore_2fframework_2fvariable_2eproto::InitDefaultsVariableDef();
  }
  SharedCtor();
  ...
  if (this->has_save_slice_info_def()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        4, *save_slice_info_def_, deterministic, target);
  }
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::VariableDef* Arena::CreateMessage< ::tensorflow::VariableDef >(Arena* arena) {
  return Arena::CreateMessageInternal< ::tensorflow::VariableDef >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::SaveSliceInfoDef* Arena::CreateMessage< ::tensorflow::SaveSliceInfoDef >(Arena* arena) {
